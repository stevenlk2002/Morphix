...
const MOCK_MESSAGES = [
  ...
  { id: 2, role: 'ai', content: '您好！很高兴为您介绍。我们的产品线覆盖护肤、彩妆和个护三大类，您对哪一类比较感兴趣呢？', score: 92 },
  { id: 3, role: 'user', content: '我是敏感肌，有什么推荐的护肤品吗？' },
  { id: 4, role: 'ai', content: '针对敏感肌，我推荐我们的舒缓修护系列，成分温和无刺激，特别添加了积雪草和神经酰胺，可以有效舒缓肌肤、修复屏障。目前正在做买二送一活动，您需要了解详细信息吗？', score: 88 },
]
...
export default function TrainingTab({ bot }) {
    ...
    <div className="training-tab">
      <div className="training-main">
        <div className="training-header">
          ...
          <Button variant="ghost" size="sm" icon={<RefreshCw size={14} />} onClick={handleReset}>
            重置对话
          </Button>
        </div>
